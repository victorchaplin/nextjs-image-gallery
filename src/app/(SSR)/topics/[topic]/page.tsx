...
export const dynamicParams = false; // tells nextjs to only allow the specified query params
  ...
  return (
    <div>
      <Alert>
        ...
        generateStaticParams will be fetched and rendered on first access and then{" "}
